...
uiGap       = 20;       % space between uicontrols
uiBorder    = 30;       % space between edge of figure and any uicontrol
scrsize = get(0,'ScreenSize');
winTopGap   = scrsize(4)/2;       % gap between top of screen and top of figure **
winLeftGap  = scrsize(3)/2;       % gap between side of screen and side of figure **
